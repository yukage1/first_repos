...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book b3 = new Book("t3", new Author("name3", "sSurname3"), 2014, 2);
        ...
        Book b7 = new Book("t7", new Author("name7", "surname7"), 1965, 15);
        Book b8 = new Book("t8", new Author("name8", "surname8"), 2010, 3);
        ...
        BookReader bookReader1 = new BookReader("nameBkR1", "surnameBR1", 33);
        BookReader bookReader2 = new BookReader("nameBkRr2", "surnameBыR2", 99);
